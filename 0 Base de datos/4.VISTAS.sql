...
-- Created by ivans on 08/11/2021, 1:22:31  --
----------------------------------------------
...
SELECT
    ...
    FROM
       ...
       LEFT JOIN BITACORA.T_BITD_PERSONAL_DNI DNI ON DNI.ID_PERSONAL = P.ID_PERSONAL AND DNI.FLG_ESTADO=1
