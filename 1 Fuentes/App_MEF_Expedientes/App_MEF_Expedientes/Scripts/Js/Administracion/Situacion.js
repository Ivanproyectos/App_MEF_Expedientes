...
function Situacion_ConfigurarGrilla() {
    ...
    SICA.Grilla(Situacion_grilla, Situacion_barra, '', '400', '', "Lista de Situación", '', 'ID_DOMINIO', colNames, colModels, 'ID_DOMINIO', opciones);
}
...
function Situacion_actionActivo(cellvalue, options, rowObject) {
    ...
    var _btn = "<label class=\"switch\">"
        + "<input id=\"Situacion_chk_" + rowObject.ID_DOMINIO + "\" type=\"checkbox\" onchange=\"Situacion_CambiarSituacion(" + rowObject.ID_DOMINIO + "this)" + check_ + ">"
...
function Situacion_CambiarSituacion(ID_DOMINIO, MiCheck) {
    var url = baseUrl + 'Administracion/Situacion/Situacion_Situacion';
    var item = {
