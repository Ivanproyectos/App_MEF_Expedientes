...
namespace App_MEF_Expedientes.Areas.Administracion.Controllers
{
    public class EstadoController : Controller
    {
        ...
        public ActionResult Estado_Listar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            auditoria.Limpiar();
        ...
        public ActionResult Estado_Insertar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
        ...
        public ActionResult Estado_Estado(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
        ...
        public ActionResult Estado_Eliminar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.IP_MODIFICACION = Recursos.Clases.Css_IP.Obtener_IP();
        ...
        public ActionResult Estado_Actualizar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.IP_MODIFICACION = Recursos.Clases.Css_IP.Obtener_IP();
