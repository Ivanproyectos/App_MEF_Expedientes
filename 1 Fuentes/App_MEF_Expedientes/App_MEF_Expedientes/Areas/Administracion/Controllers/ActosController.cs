...
namespace App_MEF_Expedientes.Areas.Administracion.Controllers
{
    public class ActosController : Controller
    {
        ...
        public ActionResult Actos_Listar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            auditoria.Limpiar();
        ...
        public ActionResult Actos_Insertar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
        ...
        public ActionResult Actos_Estado(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
        ...
        public ActionResult Actos_Eliminar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.IP_MODIFICACION = Recursos.Clases.Css_IP.Obtener_IP();
        ...
        public ActionResult Actos_Actualizar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.IP_MODIFICACION = Recursos.Clases.Css_IP.Obtener_IP();
