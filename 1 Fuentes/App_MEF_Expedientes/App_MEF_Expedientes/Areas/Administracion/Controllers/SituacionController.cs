...
namespace App_MEF_Expedientes.Areas.Administracion.Controllers
{
    public class SituacionController : Controller
    {
        ...
        public ActionResult Situacion_Listar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            auditoria.Limpiar();
        ...
        public ActionResult Situacion_Insertar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
        ...
        public ActionResult Situacion_Estado(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
        ...
        public ActionResult Situacion_Eliminar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.IP_MODIFICACION = Recursos.Clases.Css_IP.Obtener_IP();
        ...
        public ActionResult Situacion_Actualizar(Cls_Ent_Dominio entidad)
        {
            Cls_Ent_Auditoria auditoria = new Cls_Ent_Auditoria();
            entidad.IP_MODIFICACION = Recursos.Clases.Css_IP.Obtener_IP();
