...
SICA = {
    ...
    Grilla: function (grilla, pager, identificador, height, width, caption, urlListar, id, colsNames, colsModel, sortName, opciones) {
        ...
        if (opciones.rowNumber == null) { opciones.rowNumber = 30; }
        if (opciones.rowNumbers == null) { opciones.rowNumbers = [opciones.rowNumber, 50, 100, 150]; }
        ...
        if (!opciones.GridLocal) {
            $('#' + grilla).jqGrid({
                ...
                ondblClickRow: function (rowid) {
                    ...
                    if (opciones.dobRowFunc != null) {
                        if (typeof (opciones.dobRowFunc) == 'function') { opciones.dobRowFunc(id, isSelected) }
                    }
                },
            ...
            $('#' + grilla).jqGrid({
                ...
                groupingView: {
                    ...
                    groupText: ['<b style="background-color:#FFFFDC"> {0} - {1} Campo(s) </b>'],
                ...
                ondblClickRow: function () {
                    ...
                    if (opciones.dobRowFunc != null) {
                        if (typeof (opciones.dobRowFunc) == 'function') {
                            opciones.dobRowFunc(rowKey)
                        }
                    }
                },
